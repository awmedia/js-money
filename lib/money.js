...
Money.currencies = null;

Money.setCurrencies = function(currencies) {
    if (Money.currencies) {
        for (var i in Money.currencies) {
            delete Money[i];
        }
    }
...
Money.setCurrencies(currencies);

module.exports = extend(Money);
